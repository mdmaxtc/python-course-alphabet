...
class Cat:
    ...
    * Implement get_average_speed and return average_speed
    ...
    def run(self, hours):
        ...
        print(f"Your cat ran {run_km} kilometers")
...
class House:
    ...
    * Implement method get_door_price that receives material and returns price of the door
    ...
    * Implement method get_room_square that returns the square of our room
    ...
    def get_number_of_rolls_of_wallpapers(self, roll_width_m, roll_length_m):
        if roll_width_m == 0 or roll_length_m == 0:
            ...
            return sum([wall.number_of_rolls_of_wallpaper() for wall in self.__walls])
